...
<body>
    ...
    <main style="margin-top: 3rem; margin-bottom: 3rem;">
        <div id="products-container">
            <?php
                $data = json_decode(file_get_contents('data/shop/shop-products.json'));

                function create_product_card($id, $src, $name, $price) {
                    return "
                ...
                foreach ($data as $key => $product) {
                    echo create_product_card($key, $product->thumb, $product->name, $product->price);
                }
            ?>
        </div>
    </main>
